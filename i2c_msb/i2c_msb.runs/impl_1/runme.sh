...
HD_PWD='D:/Vivado/VIVADO Projects/i2c_msb/i2c_msb.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_msb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source i2c_msb.tcl -notrace
