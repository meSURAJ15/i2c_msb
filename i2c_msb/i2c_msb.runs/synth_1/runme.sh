...
HD_PWD='D:/Vivado/VIVADO Projects/i2c_msb/i2c_msb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_msb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2c_msb.tcl
